...
public class PostTests {
        ...
        @Test
        @TestDetails(author = { "Zeta" }, category = { CategoryType.STORYTESTING })
        ...
        @Test
        @TestDetails(author = { "Alex" }, category = { CategoryType.STORYTESTING })
        public void postUserForSkip() {
                throw new SkipException("Data not available");
        }

        @Test
        @TestDetails(author = { "Zarvis" }, category = { CategoryType.SMOKE })
        ...
        @Test
        @TestDetails(author = { "Rahul" }, category = { CategoryType.MINIREGRESSION })
        ...
        @Test
        @TestDetails(author = { "Rahul" }, category = { CategoryType.REGRESSION })
